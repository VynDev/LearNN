...
The generated library (LearNN.a/LearNN.so) is in the **lib** folder  
...
```
g++ -I path_to_LearNN/include -L path_to_LearNN/lib main.cpp -o xor -lLearNN
./xor
```
...
There is no html documentation available for the moment because the lib is still experimental/in development and 
